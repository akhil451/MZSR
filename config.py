...
parser.add_argument('--testpath', type=str, dest='testpath', default='../Input_test',required=False)
...
parser.add_argument('--num', type=int, dest='num_of_adaptation', default=1)
